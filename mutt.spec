...
Source0  : ftp://ftp.mutt.org/pub/mutt/mutt-1.8.3.tar.gz
Source99 : ftp://ftp.mutt.org/pub/mutt/mutt-1.8.3.tar.gz.asc
...
export LANG=C
export SOURCE_DATE_EPOCH=1496328924
