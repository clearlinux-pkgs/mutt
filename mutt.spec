...
Source0  : https://bitbucket.org/mutt/mutt/downloads/mutt-2.2.14.tar.gz
Source1  : https://bitbucket.org/mutt/mutt/downloads/mutt-2.2.14.tar.gz.asc
Source2  : ADEF768480316BDA.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) ADEF768480316BDA' gpg.status
%setup -q -n mutt-2.2.14
cd %{_builddir}/mutt-2.2.14
pushd ..
cp -a mutt-2.2.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740063523
