...
Source0  : https://bitbucket.org/mutt/mutt/downloads/mutt-2.2.3.tar.gz
Source1  : https://bitbucket.org/mutt/mutt/downloads/mutt-2.2.3.tar.gz.asc
...
%prep
%setup -q -n mutt-2.2.3
cd %{_builddir}/mutt-2.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649805663
...
cp %{_builddir}/mutt-2.2.3/COPYRIGHT %{buildroot}/usr/share/package-licenses/mutt/84ed08b606e0b21c6151551578ec8c9bbd336340
%make_install
%find_lang mutt
