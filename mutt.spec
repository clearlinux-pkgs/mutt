...
Source0  : https://bitbucket.org/mutt/mutt/downloads/mutt-2.0.7.tar.gz
Source1  : https://bitbucket.org/mutt/mutt/downloads/mutt-2.0.7.tar.gz.asc
...
%prep
%setup -q -n mutt-2.0.7
cd %{_builddir}/mutt-2.0.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620158786
...
cp %{_builddir}/mutt-2.0.7/COPYRIGHT %{buildroot}/usr/share/package-licenses/mutt/36ba45937c7ef0f178869ef07a53fa0ea8a7cf4e
%make_install
%find_lang mutt
