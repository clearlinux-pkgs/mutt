...
Source0  : https://bitbucket.org/mutt/mutt/downloads/mutt-2.2.7.tar.gz
Source1  : https://bitbucket.org/mutt/mutt/downloads/mutt-2.2.7.tar.gz.asc
...
%prep
%setup -q -n mutt-2.2.7
cd %{_builddir}/mutt-2.2.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659969404
