...
Source0  : https://bitbucket.org/mutt/mutt/downloads/mutt-2.2.13.tar.gz
Source1  : https://bitbucket.org/mutt/mutt/downloads/mutt-2.2.13.tar.gz.asc
...
%prep
%setup -q -n mutt-2.2.13
cd %{_builddir}/mutt-2.2.13
pushd ..
cp -a mutt-2.2.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710168875
