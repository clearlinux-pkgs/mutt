...
Source0  : ftp://ftp.mutt.org/pub/mutt/mutt-1.14.7.tar.gz
Source1  : ftp://ftp.mutt.org/pub/mutt/mutt-1.14.7.tar.gz.asc
...
%prep
%setup -q -n mutt-1.14.7
cd %{_builddir}/mutt-1.14.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598903208
...
cp %{_builddir}/mutt-1.14.7/COPYRIGHT %{buildroot}/usr/share/package-licenses/mutt/9a05e4157c80d693ee0e8b9427a3b5c3176ed697
%make_install
%find_lang mutt
